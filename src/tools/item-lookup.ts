...
export function registerItemLookup(server: McpServer): void {
  server.registerTool("item_lookup", { description: "Search for items within a 1Password vault by title substring. Returns item IDs, titles, categories, and vault IDs.", inputSchema: z.object({
